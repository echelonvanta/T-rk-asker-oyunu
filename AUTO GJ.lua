...
-- Sayıyı Türkçe kelimelere çevirme fonksiyonu (1'den 1000'e kadar, baş harf büyük, diğerleri küçük, sonda nokta)
local function numberToTurkish(num)
    local ones = {"Bir", "İki", "Üç", "Dört", "Beş", "Altı", "Yedi", "Sekiz", "Dokuz"}
    local tens = {"On", "Yirmi", "Otuz", "Kırk", "Elli", "Altmış", "Yetmiş", "Seksen", "Doksan"}
    local hundreds = {"Yüz", "İki yüz", "Üç yüz", "Dört yüz", "Beş yüz", "Altı yüz", "Yedi yüz", "Sekiz yüz", "Dokuz yüz"}

    if num == 1000 then return "Bin." end
    ...
    return result .. "." -- Sonda nokta ekle
end
